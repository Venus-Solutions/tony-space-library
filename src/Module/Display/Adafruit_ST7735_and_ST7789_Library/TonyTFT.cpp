...
*/
TonyTFT::TonyTFT(int8_t cs, int8_t dc, int8_t mosi,
...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
TonyTFT::TonyTFT(int8_t cs, int8_t dc, int8_t rst) :
...
TonyTFT::TonyTFT(int8_t slot) :
Adafruit_ST77xx(320, 240,find_cs(slot),find_dc(slot,0),find_rst(slot,0)) 
{
	
}

TonyTFT::TonyTFT(int8_t slot,uint8_t tfttype = TFT_240_240) :
...
/*!
    ...
    @param  rst       Reset pin # (optional, pass -1 if unused)
*/
TonyTFT::TonyTFT(SPIClass *spiClass, int8_t cs, int8_t dc,
...
*/
/**************************************************************************/
void TonyTFT::init(uint16_t width, uint16_t height, uint8_t mode) {
...
*/
/**************************************************************************/
void TonyTFT::setRotation(uint8_t m) {
  uint8_t madctl = 0;
